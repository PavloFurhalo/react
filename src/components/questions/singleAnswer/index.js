    ...
    {props.answers.map((answer, i) => {
     ...
     return (<div>
      <input
       ...
       checked =  {props.correctAnswer == i && showCorrectAnswer ? true : false}
      />
      {props.correctAnswer == i && showCorrectAnswer ? <label style={{color : "green"}} for={id}>{answer}</label> : <label for={id}>{answer}</label>}
